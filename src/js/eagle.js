var eagle__btn = document.querySelector(".eagle__btn");
...
eagle__btn.addEventListener("click", function(){
  eagle__btn.classList.add("eagle__btn--active");
...
donate_to_volunteers_off.addEventListener("click", function(){
  donate_to_volunteers_off.classList.remove("eagle__btn--active");
